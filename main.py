...
from quotexapi.stable_api import Quotex  # Chrome ki zaroorat nahi hai isme
...
@app.route('/')
def home():
    return "<h1>Bot is Running - CHROME ERROR FIXED</h1>"
...
# ==================== ENGINE ====================
def start_bot():
    print("🔐 Connecting (No-Chrome Mode)...")
    ...
    send_msg(f"🚀 <b>QUOTEX PRO BOT ONLINE</b>\n\n✅ <b>Chrome Error:</b> Fixed\n📊 <b>Strategy:</b> RSI, BB, MA21 Loaded\n🛡️ <b>Mode:</b> Sequential Trade Active")
